        ...
        with PdfPages(output_filename) as pdf:
            ...
            try:
                ...
                try:
                    ...
                    # Fallback visualization when heatmap fails
                    ax15.imshow(original_pil)
                    ax15.set_title("Original Image (Heatmap Error)", fontsize=12)
                    print(f"  Warning: Heatmap creation failed: {heatmap_err}")
                ax15.axis('off')
